...
public class ThemeManagerWindow implements IMinecraft {
    ...
    private static final File THEME_DIR = new File("fgangvisuals");
    ...
    public void loadThemes() {
        ...
        try {
            ...
            e.printStackTrace();
            System.err.println("Ошибка при загрузке тем FGANGVisuals!");
        }
    }

    private void updateClientTheme(int c1, int c2) {
        com.fgangvisuals.module.settings.impl.ThemeManager.getInstance()
                .getCurrentTheme()
                .setColors(c1, c2);
    }
