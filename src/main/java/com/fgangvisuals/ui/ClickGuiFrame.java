...
public class ClickGuiFrame extends Screen implements IMinecraft {
    ...
    public ClickGuiFrame() {
        ...
        for (ModuleCategory category : ModuleCategory.values()) {
            if (category == ModuleCategory.COMBAT) continue;
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        float themeRight = themeManager.getX() + themeManager.getWidth() + 8;
        float startX = Math.max(themeRight, (windowWidth - panelTotalWidth) / 2f);
