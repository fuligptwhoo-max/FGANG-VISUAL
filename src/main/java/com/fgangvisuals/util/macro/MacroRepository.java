package com.fgangvisuals.util.macro;
...
public class MacroRepository implements IMinecraft, QuickLogger {
    ...
    private final File file = new File("fgangvisuals/macros.json");
    ...
    public void onKey(EventKeyInput event) {
        ...
        for (Macro macro : macroList) {
            ...
            if (msg.startsWith(".")) {
                msg = msg.substring(1);
                FGANGVisuals.getInstance().getCommandDispatcher().runCommand(msg);
            } else {
