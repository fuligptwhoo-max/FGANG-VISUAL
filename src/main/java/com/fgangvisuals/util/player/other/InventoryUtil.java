package com.fgangvisuals.util.player.other;
...
import com.fgangvisuals.module.list.movement.Sprint;
...
public class InventoryUtil implements IMinecraft {
    ...
    public static void swapWithBypassGrim(Runnable runnable) {
        ...
        try {
            ...
            if (FGANGVisuals.getInstance().getServerManager().isServerSprinting()) {
