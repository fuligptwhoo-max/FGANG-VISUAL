package com.fgangvisuals.util.render.builders.impl;

import net.minecraft.text.Text;
import com.fgangvisuals.util.render.builders.AbstractBuilder;
import com.fgangvisuals.util.render.msdf.MsdfFont;
import com.fgangvisuals.util.render.renderers.impl.BuiltMutableText;
