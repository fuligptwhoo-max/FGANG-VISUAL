...
import com.fgangvisuals.event.list.ChatEvent;
import com.fgangvisuals.event.list.TabCompleteEvent;
...
public class CommandDispatcher {
    ...
    public CommandDispatcher() {
        this.manager = FGANGVisuals.getInstance().getCommandRepository();
